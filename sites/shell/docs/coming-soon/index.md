...
shipping in the [`riddlg`](/riddlg/latest/) tool, others still
under active development and coming through
[Synapify](/synapify/latest/) and related tooling. Each entry below is
...
Synapify, see the [Synapify Simulation Guide](/synapify/latest/simulation/).
...
!!! tip "Most generation is available today"
    ...
    [`riddlg`](/riddlg/latest/) tool — see
    [Generators](/riddlg/latest/generators/) for the full catalog. The
...
!!! note "Timeline"
    ...
    [Synapify documentation](/synapify/latest/).
